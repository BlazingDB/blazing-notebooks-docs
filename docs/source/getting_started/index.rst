...
First, log in to the app with your Google credentials.

.. raw:: html

    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex text-center image">
        <div class="shadow image text-center ">
            <img src="../_static/images/app_login.png" alt="create_cluster" width=600/>
        </div>
    </div>
...
Once you log in you can either use our :doc:`Freemium offering <../freemium/index>` 
or you can create a :doc:`Private cluster <../private_clusters/cluster/index>`. Either
way you will get access to a GPU where you can run this example.

We will be working in the Jupyter Lab window.

.. raw:: html

    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex text-center image">
        <div class="shadow image text-center ">
            <img src="../_static/images/jupyter_window.png" alt="create_cluster" width=600/>
        </div>
    </div>
